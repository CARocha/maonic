...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OpcionesManejo.volumen'
        db.delete_column('opciones_agroecologico_opcionesmanejo', 'volumen')

    def backwards(self, orm):
        # Adding field 'OpcionesManejo.volumen'
        db.add_column('opciones_agroecologico_opcionesmanejo', 'volumen',
    ...
    models = {
        ...
        'opciones_agroecologico.opcionesmanejo': {
            ...
            'uso': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['opciones_agroecologico.ManejoAgro']"})
        }
    }

    complete_apps = ['opciones_agroecologico']