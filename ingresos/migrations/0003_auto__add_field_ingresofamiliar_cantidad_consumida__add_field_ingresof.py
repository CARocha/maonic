...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IngresoFamiliar.cantidad_consumida'
        db.add_column('ingresos_ingresofamiliar', 'cantidad_consumida',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'IngresoFamiliar.precio_real'
        db.add_column('ingresos_ingresofamiliar', 'precio_real',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'IngresoFamiliar.cantidad_consumida'
        db.delete_column('ingresos_ingresofamiliar', 'cantidad_consumida')

        # Deleting field 'IngresoFamiliar.precio_real'
        db.delete_column('ingresos_ingresofamiliar', 'precio_real')
    ...
    models = {
        ...
        'ingresos.ingresofamiliar': {
            'Meta': {'object_name': 'IngresoFamiliar'},
            'cantidad': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'cantidad_consumida': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuestas.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'maneja_negocio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ingresos.IngresoManeja']", 'null': 'True', 'blank': 'True'}),
            'precio': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'precio_real': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'quien_vendio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ingresos.IngresoVendio']", 'null': 'True', 'blank': 'True'}),
            'rubro': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ingresos.RubrosI']"})
        },
        'ingresos.ingresomaneja': {
            'Meta': {'object_name': 'IngresoManeja'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '150'})
        },
        'ingresos.ingresovendio': {
            'Meta': {'object_name': 'IngresoVendio'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '150'})
        },
        'ingresos.otrosingresos': {
            ...
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuestas.Encuesta']"}),
            'fuente': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ingresos.Fuentes']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'tiene_ingreso': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ingresos.IngresoManeja']", 'null': 'True', 'blank': 'True'}),
            'tipo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ingresos.TipoTrabajo']", 'null': 'True', 'blank': 'True'})
        },
        'ingresos.rubrosi': {
            'Meta': {'ordering': "['nombre']", 'object_name': 'RubrosI'},
