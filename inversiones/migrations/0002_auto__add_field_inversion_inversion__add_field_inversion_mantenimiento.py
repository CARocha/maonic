...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Inversion.inversion'
        db.add_column('inversiones_inversion', 'inversion',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Inversion.mantenimiento'
        db.add_column('inversiones_inversion', 'mantenimiento',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Inversion.inversion'
        db.delete_column('inversiones_inversion', 'inversion')

        # Deleting field 'Inversion.mantenimiento'
        db.delete_column('inversiones_inversion', 'mantenimiento')
    ...
    models = {
        ...
        'inversiones.inversion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inversion': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'mano_obra': ('django.db.models.fields.FloatField', [], {}),
            'mantenimiento': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
