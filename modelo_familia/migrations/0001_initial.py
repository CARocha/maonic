...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('modelo_familia_arboles', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('modelo_familia', ['Arboles'])

        # Adding model 'InventarioForestal'
        db.create_table('modelo_familia_inventarioforestal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('arboles', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelo_familia.Arboles'])),
        ...
        db.send_create_signal('modelo_familia', ['InventarioForestal'])

        # Adding model 'UsoInsumos'
        db.create_table('modelo_familia_usoinsumos', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('modelo_familia', ['UsoInsumos'])

        # Adding model 'InsumosUtilizados'
        db.create_table('modelo_familia_insumosutilizados', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uso', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelo_familia.UsoInsumos'])),
            ('volumen', self.gf('django.db.models.fields.FloatField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuestas.Encuesta'])),
        ))
        db.send_create_signal('modelo_familia', ['InsumosUtilizados'])

        # Adding model 'ItemsFamiliar'
        db.create_table('modelo_familia_itemsfamiliar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('modelo_familia', ['ItemsFamiliar'])

        # Adding model 'EgresoFamiliar'
        db.create_table('modelo_familia_egresofamiliar', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('producto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['modelo_familia.ItemsFamiliar'])),
            ('costo', self.gf('django.db.models.fields.FloatField')()),
            ('encuesta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['encuestas.Encuesta'])),
        ))
        db.send_create_signal('modelo_familia', ['EgresoFamiliar'])

    def backwards(self, orm):
        # Deleting model 'Arboles'
        db.delete_table('modelo_familia_arboles')

        # Deleting model 'InventarioForestal'
        db.delete_table('modelo_familia_inventarioforestal')

        # Deleting model 'UsoInsumos'
        db.delete_table('modelo_familia_usoinsumos')

        # Deleting model 'InsumosUtilizados'
        db.delete_table('modelo_familia_insumosutilizados')

        # Deleting model 'ItemsFamiliar'
        db.delete_table('modelo_familia_itemsfamiliar')

        # Deleting model 'EgresoFamiliar'
        db.delete_table('modelo_familia_egresofamiliar')
    ...
    models = {
        ...
        'mapeo.familia': {
            ...
            'cedula': ('django.db.models.fields.CharField', [], {'max_length': '16', 'blank': 'True'}),
            'celular': ('django.db.models.fields.CharField', [], {'max_length': "'8'", 'null': 'True', 'blank': 'True'}),
            'certificacion': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['mapeo.Certificacion']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'modelo_familia.arboles': {
            'Meta': {'object_name': 'Arboles'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'modelo_familia.egresofamiliar': {
            'Meta': {'object_name': 'EgresoFamiliar'},
            'costo': ('django.db.models.fields.FloatField', [], {}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuestas.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'producto': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modelo_familia.ItemsFamiliar']"})
        },
        'modelo_familia.insumosutilizados': {
            'Meta': {'object_name': 'InsumosUtilizados'},
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuestas.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uso': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modelo_familia.UsoInsumos']"}),
            'volumen': ('django.db.models.fields.FloatField', [], {})
        },
        'modelo_familia.inventarioforestal': {
            'Meta': {'object_name': 'InventarioForestal'},
            'arboles': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['modelo_familia.Arboles']"}),
            'cantidad': ('django.db.models.fields.FloatField', [], {}),
            'encuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['encuestas.Encuesta']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'modelo_familia.itemsfamiliar': {
            'Meta': {'object_name': 'ItemsFamiliar'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'modelo_familia.usoinsumos': {
